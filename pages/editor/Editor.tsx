...
export default function EditorPage() {
  useEffect(() => {
    ...
    TextdrawSystem.create<TextTextDraw, TTextTextDrawProps>(TextTextDraw, board1, { sizeWidth: 200, sizeHeight: 50, posX: 50, posY: 50, textColor: '#FF00FFAA', font: TextDrawFont.Stylized, shadowSize: 1, highlightColor: '#00FFFFFF' });
